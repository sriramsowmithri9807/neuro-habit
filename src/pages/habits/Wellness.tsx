      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex items-center mb-8">
          ...
          <div className="flex-1">
            <h1 className="text-3xl font-bold text-gray-900 mb-2">Wellness Habits</h1>
            <p className="text-gray-600">Nurture your mental and emotional well-being</p>
          </div>
          <Button 
        ...
        {showForm && (
          <Card className="p-6 mb-8">
            <h3 className="text-lg font-semibold mb-4">Create New Wellness Habit</h3>
            <div className="space-y-4">
              ...
              <div>
                ...
                <Textarea
                  ...
                  placeholder="Describe your wellness practice..."
                />
              </div>
              <div>
